      ...
      <div className="container">
        <div style={{ marginTop: "4rem" }} className="row">
          <div className="col s6 offset-s3">
            ...
            <img src={"logo.png"} width="15%" height="auto" />
            ...
            <p className="grey-text text-darken-1">
                <Link to="/register" style={{color:"black",textDecoration:"underline"}}>Don't have an account?</Link>
              </p>
            </div>
            <div className="col s6 right-align">
              <p className="grey-text text-darken-1">
              <Link to="/register" style={{color:"black",textDecoration:"underline"}}>Forgot Password?</Link>
